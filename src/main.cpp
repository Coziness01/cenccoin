...
// Copyright (c) 2017 The ZybCoin Developers
...
uint256 hashGenesisBlock("00000cc178bb2e3ca76483c22ae7aed8f02e9810c40d989023a7d720bb4334ce");//，替换2.0
static const unsigned int timeGenesisBlock = 1493984980;//1456048686;//替换1.0
...
const string strMessageMagic = "ZybCoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees, unsigned int nBits)
{
	...
	if (nHeight == 1) 
    {
        nSubsidy = 10000000000 * COIN;//替换1.3
    }
	else if (nHeight > 1 )
    {
        nSubsidy = 0 * COIN;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
       const char* pszTimestamp = "already in already databases we ZybCoin from USA with Transactions.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = 261535;//替换1.2，替换2.2
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("dfe6aae851a34f9d8e4c2369e9b77edb3f7d274d5bee5d0c3a4076fc8b1f8ede"));//替换2.1
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ZybCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ZybCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("ZybCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("ZybCoin-miner");
    ...
    try { loop {
        ...
        printf("Running ZybCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("ZybCoinMiner terminated\n");
        throw;
    }
}
